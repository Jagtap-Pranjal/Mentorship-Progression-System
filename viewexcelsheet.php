...
<tr>  
  <th>SR_NO</th>
        ...
        <td><a href="viewexcelsheet.php?deleteid=<?php echo $rows['SR_NO']; ?>"> <button type="button">Delete</button> </a>
        <a href="viewexcelsheet.php?editid=<?php echo $rows['SR_NO']; ?>">  <button type="button">Edit </button></a></td>
      </tr> 
