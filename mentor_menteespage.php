...
<html> 
    ...
    <tr>  
        ...
        <a href="edit.php?editid=<?php echo $rows['ENROLLMENT_NO']; ?>"><button >Edit</button></a>
        <a href="mentor_menteespage.php?deleteid=<?php echo $rows['ENROLLMENT_NO']; ?>"><button >Delete</button></a>     
      </td>
