...
<ul class="menu" id="menu">
      <li><a href="hod_mentorpage.php" class="menu-btn">Go Back</a></li>
</ul>
<div class="menu-btn">
...
<br><br><br>
 <center><td><a href="export.php?view=<?php echo $_GET["view"]."&&download=1"?>" target="_blank">Download</a></td></center>
</section> 
</body>
</html>