...
<ul class="menu" id="menu">
                  ...
                  <li><a href="add notice.php" class="menu-btn">Notice</a></li>
                  <li><a href="FP_hod.php" class="menu-btn">Settings</a></li>
...
//select register_mentor where password = $_GET['view']
$query = "SELECT * FROM register_mentor WHERE password = '$_GET[view]'";
...
<br><br><br>
 <center><td><a href="export.php?view=<?php echo $_GET["view"]."&&download=1"?>" target="_blank"><button>Download</button></a></td></center>
</section> 
</body>
</html>