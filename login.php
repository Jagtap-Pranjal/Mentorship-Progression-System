...
<div class="box">
              <div class="icon">MI</div>
                <div class="content">
                <h2>Mentor Incharge</h2>

                <a href="mentorinchargelogin.php">Login</a>
              </div>
              </div>
                ...
                <div class="box">
                  <div class="icon">M</div>
                    ...
                    <a href="mentorlogin.php">Login</a>
                  </div>
                </div>
</section>
</script>
<section class="container" id="container2"  style="background-color:#080706">
</body>
</html>