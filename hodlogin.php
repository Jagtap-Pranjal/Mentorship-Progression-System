...
<div class="main">
        ...
        <a href="FP_hod.php"><button type="submit">Forget Password</button>
        <a href="restrict_hod.php"><button type="submit">Dont Have An Account...?Register Here</button>
</div>
</div>
<a href="adminvalidation_hod.php">  </a>
</body>
</html>