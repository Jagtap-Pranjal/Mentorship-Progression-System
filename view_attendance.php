...
$result = mysql_query("SELECT st_status,date,CLASS,NAME,ENROLLMENT_NO FROM attendance where date = '$str' and MENTOR_ID='$var'");
...
?> 
    ...
    <center><h2><b><label>ATTENDANCE RECORD</b></h2></label>
</center><br>
    <table align="center" border="3px" style="width:900px; line-height:30px;">
      <tr>
        <th>DATE</th>
        <th>CLASS</th>
        <th>NAME</th>
